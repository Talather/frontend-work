  ...
  return (
    ...
    <MarkChatUnreadIcon sx={{ color: 'white' }} />
      ...
      <List sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
        <ListItem button component={Link} to="/home" sx={{ justifyContent: 'center' }}>
          <ListItemIcon sx={{ minWidth: 0 }}>
            <BarChartIcon sx={{color:"white",}}/>
          </ListItemIcon>
        </ListItem>
        <Divider />
        <ListItem button component={Link} to="/main" sx={{ justifyContent: 'center' }}>
          <ListItemIcon sx={{ minWidth: 0 }}>
            <EditLocationAltIcon sx={{color:"white"}}/>
          </ListItemIcon>
        </ListItem>
        <Divider />
        <ListItem button component={Link} to="/contact" sx={{ justifyContent: 'center' }}>
          <ListItemIcon sx={{ minWidth: 0 }}>
